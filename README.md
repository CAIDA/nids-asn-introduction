...
- step 4 [open and complete the notebook](notebook.ipynb)

## Commit/Submit

Submit the following file.

- [notebook.ipynb](notebook.ipynb) — complete tasks 2 and 3 and answer all six questions
...
├- notebook.ipynb                   ⬅  # Tasks and report — open and complete this
└- scripts/
|  └- org-download.py                  # downloads from the as2org API (provided)
└- tables/
   ├- asn-cone-tiers.md               # generated by the notebook (task 2)
   └- country-cone-tiers.md           # generated by the notebook (task 3)
```
