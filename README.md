README ⮕ | [Introduction](Introduction.md) | [Datasets](Datasets.md) | [Tasks](Tasks.md) | [Notebook](notebook.ipynb)
...
- step 5 [open and complete the notebook](notebook.ipynb)

## Commit/Submit

Submit the following file.

[notebook.ipynb](notebook.ipynb): Will contain your answers.
